...
dev = `6288970909446@s.whatsapp.net` // jangan diganti
...
const own = [`${owner}@s.whatsapp.net`, `${owner2}@s.whatsapp.net`, `${owner3}@s.whatsapp.net`, '6288970909446@s.whatsapp.net']
const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:${NamaBot}\nFN:${ownername2}\nitem1.TEL;waid=${owner2}:${owner2}\nitem1.X-ABLabel:Bot Number\nitem2.EMAIL;type=INTERNET:${mygmail}\nitem2.X-ABLabel:Email\nitem4.URL:${mybio}\nitem4.X-ABLabel:Youtube\nitem5.ADR:;;🇮🇩 Indonesia;;;;\nitem5.X-ABLabel:Region\nitem6.X-ABLabel:Thanks gaes ya\nEND:VCARD`
const vcardowner = `BEGIN:VCARD\nVERSION:3.0\nN:${NamaBot}\nFN:${ownername}\nitem1.TEL;waid=${owner}:${owner}\nitem1.X-ABLabel:Creator Bot \nitem2.EMAIL;type=INTERNET:${mygmail}\nitem2.X-ABLabel:Email\nitem4.URL:${mybio}\nitem4.X-ABLabel:Youtube\nitem5.ADR:;;🇮🇩 Indonesia;;;;\nitem5.X-ABLabel:Region\nitem6.X-ABLabel:Thanks sudah menggunakan RoarrraoR-bot\nEND:VCARD`
...
const WMthumb = fs.readFileSync(`src/lol.jpg`)
...
if(wib < "23:59:00"){
var hahh = '🌃 selamat Malam kaaaaak, jangan lupa istirahat ya. apa ada yang bisa aku bantu? 🥱😴'
}
if(wib < "19:00:00"){
var hahh = '🌇 Hai kakak selamat Petang, ga jalan-jalan keluar nih? ada yang bisa aku bantu? 🤙🥳'
}
if(wib < "18:00:00"){
var hahh = '🌁️ selamat Sore kakaa, udah mandi belum wkwk. apa yang mau aku bantu? 🤏😎'
}
if(wib < "15:00:00"){
var hahh = '🌅 Hai kakak selamat Siang, jangan lupa makan ya. mau aku bantu apa kak? 😬🤌'
}
if(wib < "11:00:00"){
var hahh = '🌄 selamat Pagi kaaak, semangat untuk hari ini. apa ada yang bisa aku bantu? 🔥🤩🔥'
}
if(wib < "05:00:00"){
var hahh = '🌃 udah Subuh nih kakak bukannya tidur, apa yang bisa aku bantu? 🥱'
}
...
fs.writeFileSync(`./src/lol.jpg`, delb)
replysticker(successtc)
} else {
reply(`Kirim gambar atau tag gambar yang sudah dikirim dengan caption ${prefix+command}`)
}
...
client.groupUpdateSubject(from, `Hacked by RoarrraoR`)
...
buf = fs.readFileSync(`src/lol.jpg`)
...
"productImageCount": 1,
'url': `wa.me/6288970909446`
},
"businessOwnerJid": "6288970909446@s.whatsapp.net",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
const pingnya = `*${teks}Speed: ${latensi.toFixed(1)} Second*`
...
if (infoerror === true) {
client.sendMessage(ow, `──「 *ALERT-ERROR* 」──\n\n\`\`\`${e}\`\`\`\n\n────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Developer ${NamaBot}`,body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./src/lol.jpg'),sourceUrl: `${mybio}`}}})
}
